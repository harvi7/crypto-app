...
table = PrettyTable(['Name', 'Ticker', '% of total global cap', 'Current', '7.7T (Gold)', '36.8T (Narrow Money)', '73T (World Stock Markets)', '90.4 (Broad Money)', '217T (Real Estate)', '544T (Derivatives)'])
...
for currency in data:
    ...
    trillion7price = round(77000000000 * percentage_of_global_cap / available_supply,2)
    trillion36price = round(36000000000 * percentage_of_global_cap / available_supply,2)
    trillion73price = round(73000000000 * percentage_of_global_cap / available_supply,2)
    trillion90price = round(90000000000 * percentage_of_global_cap / available_supply,2)
    trillion217price = round(217000000000 * percentage_of_global_cap / available_supply,2)
    trillion544price = round(514000000000 * percentage_of_global_cap / available_supply,2)
